"""
MASA 17_Scientific Calculator using Tkinter in Python with Source Code
Developer: MASA
"""
...
root = Tk()
root.title("MASA Scientific Precision Calculator")
...
txtDisplay = Entry(
    calc, font=("Helvetica", 20, "bold"), bg="#36454F", fg="white", bd=30, width=28, justify=RIGHT
)
